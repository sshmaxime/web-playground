...
import { Input } from "@web-playground/ui/shadcn/components/input";
import { Separator } from "@web-playground/ui/shadcn/components/separator";
import { Sheet, SheetContent } from "@web-playground/ui/shadcn/components/sheet";
import { Skeleton } from "@web-playground/ui/shadcn/components/skeleton";
import {
	Tooltip,
	TooltipContent,
	TooltipProvider,
...
import { useIsMobile } from "@web-playground/ui/shadcn/hooks/use-mobile";
		...
		return (
			<main
				...
				className={cn(
					...
					"peer-data-[variant=inset]:min-h-[calc(100full-theme(spacing.4))] md:peer-data-[variant=inset]:m-2 md:peer-data-[state=collapsed]:peer-data-[variant=inset]:ml-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow",
					className,
				)}
				{...props}
			/>
